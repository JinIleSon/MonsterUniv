...
public class Sql_Adm_counsel {

	// article
	public static final String SELECT_COUNT_TOTAL = "SELECT COUNT(*) FROM adm_counsel";

	// 검색 기능
	public static final String SELECT_COUNT_SEARCH = "SELECT COUNT(*) FROM adm_counsel ";

	public static final String SELECT_ARTICLE_SEARCH = "SELECT * FROM adm_counsel ";
	...
	public static final String SELECT_ARTICLE_ALL = "SELECT * FROM adm_counsel\r\n"
													+ "ORDER BY id DESC\r\n"
													+ "LIMIT 10 OFFSET ?";
	// main에 들어감
	public static final String SELECT_ARTICLE_THREE = "SELECT * FROM adm_counsel\r\n"
														+ "ORDER BY id DESC\r\n"
														+ "LIMIT 3 OFFSET 1";
	// 파일 부분
...
//														+ "WHERE A.ANO = ?";
	...
	public static final String SELECT_MAX_ID = "SELECT MAX(id) FROM adm_counsel";
