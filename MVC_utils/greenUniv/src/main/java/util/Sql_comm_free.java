...
public class Sql_comm_free {

	// article
	public static final String SELECT_COUNT_TOTAL = "SELECT COUNT(*) FROM commu_free";

	// 검색 기능
	public static final String SELECT_COUNT_SEARCH = "SELECT COUNT(*) FROM commu_free ";

	public static final String SELECT_ARTICLE_SEARCH = "SELECT * FROM commu_free ";
	...
	public static final String SELECT_ARTICLE_ALL = "SELECT * FROM commu_free\r\n"
													+ "ORDER BY id DESC\r\n"
													+ "LIMIT 10 OFFSET ?";
	// 파일 부분
...
//														+ "WHERE A.ANO = ?";
	...
	public static final String SELECT_MAX_ID = "SELECT MAX(id) FROM commu_free";
