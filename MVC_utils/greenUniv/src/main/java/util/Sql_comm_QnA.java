...
public class Sql_comm_QnA {

	// article
	public static final String SELECT_COUNT_TOTAL = "SELECT COUNT(*) FROM commu_qna";

	// 검색 기능
	public static final String SELECT_COUNT_SEARCH = "SELECT COUNT(*) FROM commu_qna ";

	public static final String SELECT_ARTICLE_SEARCH = "SELECT * FROM commu_qna ";
	...
	public static final String SELECT_ARTICLE_ALL = "SELECT * FROM commu_qna\r\n"
													+ "ORDER BY id DESC\r\n"
													+ "LIMIT 10 OFFSET ?";
	// 파일 부분
...
//														+ "WHERE A.ANO = ?";
	...
	public static final String SELECT_MAX_ID = "SELECT MAX(id) FROM commu_qna";
