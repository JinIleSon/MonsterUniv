...
public class Sql_Adm_notice {

	// article
	public static final String SELECT_COUNT_TOTAL = "SELECT COUNT(*) FROM adm_notice";

	// 검색 기능
	public static final String SELECT_COUNT_SEARCH = "SELECT COUNT(*) FROM adm_notice ";

	public static final String SELECT_ARTICLE_SEARCH = "SELECT * FROM adm_notice ";
	...
	public static final String SELECT_ARTICLE_ALL = "SELECT * FROM adm_notice\r\n"
													+ "ORDER BY id DESC\r\n"
													+ "LIMIT 10 OFFSET ?";
	// main에 들어감
	public static final String SELECT_ARTICLE_THREE = "SELECT * FROM adm_notice\r\n"
														+ "ORDER BY id DESC\r\n"
														+ "LIMIT 3 OFFSET 1";
	// 파일 부분
...
//														+ "WHERE A.ANO = ?";
	...
	public static final String SELECT_MAX_ID = "SELECT MAX(id) FROM adm_notice";
