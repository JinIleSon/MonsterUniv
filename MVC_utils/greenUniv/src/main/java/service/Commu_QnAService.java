...
import dao.Commu_QnADAO;
import dto.Commu_QnADTO;
import dto.PagenationDTO;

public enum Commu_QnAService {

	INSTANCE;

	private Commu_QnADAO dao = Commu_QnADAO.getInstance();
	...
	// 기본 리스트 뿌려주기
	public List<Commu_QnADTO> findAll(int start){
		return dao.selectAll(start);
	}
	// 검색한 결과
	public List<Commu_QnADTO> findAllSearch(int start, String searchType, String keyword){
