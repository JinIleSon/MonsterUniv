...
import dao.Commu_empDAO;
import dto.Commu_empDTO;
import dto.PagenationDTO;

public enum Commu_empService {
	
	INSTANCE;
	
	private Commu_empDAO dao = Commu_empDAO.getInstance();
	...
	// 기본 리스트 뿌려주기
	public List<Commu_empDTO> findAll(int start){
		return dao.selectAll(start);
	}
	// 검색한 결과
	public List<Commu_empDTO> findAllSearch(int start, String searchType, String keyword){
