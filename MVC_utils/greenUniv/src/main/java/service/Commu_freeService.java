...
import dao.Commu_freeDAO;
import dto.Commu_freeDTO;
import dto.PagenationDTO;

public enum Commu_freeService {
	
	INSTANCE;
	
	private Commu_freeDAO dao = Commu_freeDAO.getInstance();
	...
	// 기본 리스트 뿌려주기
	public List<Commu_freeDTO> findAll(int start){
		return dao.selectAll(start);
	}
	// 검색한 결과
	public List<Commu_freeDTO> findAllSearch(int start, String searchType, String keyword){
