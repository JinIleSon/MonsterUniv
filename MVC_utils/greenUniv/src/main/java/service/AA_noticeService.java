...
public enum AA_noticeService {
	...
	// 기본 리스트 뿌려주기
	public List<AA_noticeDTO> findAll(int start){
		return dao.selectAll(start);
	}
	// 검색한 결과
	public List<AA_noticeDTO> findAllSearch(int start, String searchType, String keyword){
