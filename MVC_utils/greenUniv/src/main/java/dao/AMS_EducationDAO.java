...
public class AMS_EducationDAO extends DBHelper {

	private static final AMS_EducationDAO INSTANCE = new AMS_EducationDAO();

	public static AMS_EducationDAO getInstance() {
		return INSTANCE;
	}

	private AMS_EducationDAO() {
	}
