...
@WebServlet("/academicAffairs/academicAffairs_notice.do")
public class ListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 페이지네이션 처리 요청
		PagenationDTO pagenationDTO = aa_noticeService.getPagenationDTO(pg, null, null);

		// 글 목록 조회
		int start = pagenationDTO.getStart();
		List<AA_noticeDTO> dtoList = aa_noticeService.findAll(start);
