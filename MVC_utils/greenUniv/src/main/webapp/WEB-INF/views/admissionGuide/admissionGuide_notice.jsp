               ...
               <hr style="border:none; border-top: 2px solid;">
                ...
                <div style=" height: 100px; margin-top:30px;">
	                <form action="" method="get" style="text-align: center; display:flex; justify-content: center;">
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.pageGroupStart}'" class="first-page">
	                    <!-- 이전 페이지: 1페이지일 때 비활성화 -->
						<c:choose>
						  ...
						  <c:otherwise>
						    <input type="button"
						           onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.currentPage-1}'"
						           class="prev-page">
						  </c:otherwise>
						</c:choose>
						
						<c:forEach var="num" begin="${pagenationDTO.pageGroupStart}" end="${pagenationDTO.pageGroupEnd}">
	                    	<input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${num}'" value="${num}" class="${pagenationDTO.currentPage == num ? 'current' : 'off'}" style="">
	                    </c:forEach>
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.pageGroupEnd}'" class="last-page">
	                </form>
                </div>
            </div>
        </div>
