...
<header>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb-content">
            ...
            <a href="#">입학안내</a>
            <img src="../images/bg-path-arrow.png" alt="화살표" style="width:8px; height:13px; margin-left:15px;"><span>수시모집</span> 
        </div>
    </div>
    ...
    <div class="inner">
        <div class="container">
            ...
            <div class="sidebar">
                ...
                <ul>
                    <li><a href="#">공지사항</a></li>
                    <li><a href="#" class="active">수시모집</a></li>
                    <li><a href="#">정시모집</a></li>
                    <li><a href="#">편입학</a></li>
                    <li><a href="#">입학상담</a></li>
                </ul>
            ...
            <div class="main-content">
                <div class="content-header">수시모집</div> 
                ...
                <div>
                    ...
                    <div style="border:1px solid #ddd; border-radius:8px; width:280px; padding:16px; background:#fff;">
                        <div style="display:inline-block; padding:4px 8px; font-size:12px; font-weight:bold; border-radius:4px; margin-bottom:8px; color:#fff; background:#f57c00;">
                            수시
                        </div>
                        <div>
                            <p style="font-size:14px; color:#555; margin:0 0 6px 0;">학생부종합전형, 지역인재전형</p>
                            <h3 style="font-size:16px; font-weight:bold; margin:0; color:black;">면접고사 사전 공지</h3>
                        </div>
                    </div>
                    </a>
                    ...
                    <div style="border:1px solid #ddd; border-radius:8px; width:280px; padding:16px; background:#fff;">
                        ...
                        <div>
                            <p style="font-size:14px; color:#555; margin:0 0 6px 0;">2026학년도 수시모집</p>
                            <h3 style="font-size:16px; font-weight:bold; margin:0; color:black;">학생부교과전형 학업역량평가안내</h3>
                        </div>
                    </div>
                    </a>
