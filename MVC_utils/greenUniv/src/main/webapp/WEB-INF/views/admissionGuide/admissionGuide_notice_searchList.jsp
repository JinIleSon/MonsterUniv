        ...
        <div style="display: flex; gap: 60px;">
            <div style=" width: 210px;" >
                ...
                <table class="banner sidebar" style="border-collapse:collapse; width:100%; border-top:2px solid black;" >
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #e9e9e9;">
                            <a href="/greenUniv/admissionGuide/admissionGuide_counsel.do" style="color: black;">입학상담</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div style="padding-top:9px; width: 930px;">
               ...
               <hr style="border:none; border-top: 2px solid;">
                <div style="display: flex; width:100%; margin-top:30px; margin-bottom:20px; justify-content: flex-end;">
                    <form action="/greenUniv/admissionGuide/admissionGuide_notice_search.do" method="get" style="display: flex;">
                ...
                <table style="border-collapse: collapse; border:1px solid; width:100%; text-align: center; border:none;">
                    ...
                    <c:forEach var="notice" items="${dtoList}" varStatus="status">
			            <tr style="height:60px;">
			                ...
			                <td style="width: 500px; border-bottom: 1px solid #b8b8b8; text-align: left;"><a href="#"><img src="/greenUniv/images/ico-new01.gif" alt=""> <a href="#" style="color:black;">${notice.title}</a></td>
                ...
                <div style=" height: 100px; margin-top:30px;">
	                <form action="" method="get" style="text-align: center; display:flex; justify-content: center;">
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.pageGroupStart}&searchType=${searchType}&keyword=${keyword}'" class="first-page">
	                    <!-- 이전 페이지: 1페이지일 때 비활성화 -->
						<c:choose>
						  ...
						  <c:otherwise>
						    <input type="button"
						           onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.currentPage-1}&searchType=${searchType}&keyword=${keyword}'"
						           class="prev-page">
						  </c:otherwise>
						</c:choose>
						
						<c:forEach var="num" begin="${pagenationDTO.pageGroupStart}" end="${pagenationDTO.pageGroupEnd}">
	                    	<input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${num}&searchType=${searchType}&keyword=${keyword}'" value="${num}" class="${pagenationDTO.currentPage == num ? 'current' : 'off'}" style="">
	                    </c:forEach>
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/admissionGuide/admissionGuide_notice.do?pg=${pagenationDTO.pageGroupEnd}&searchType=${searchType}&keyword=${keyword}'" class="last-page">
	                </form>
                </div>
            </div>
        </div>
