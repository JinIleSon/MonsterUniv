    ...
    <div style="background-color: #ECF2F6; height:42px; display:flex; align-items: center; justify-content: center;">
        <div style="width:250px; height:42px;
            ...
            ">
                ...
                <img src="/greenUniv/images/bg-path-arrow.png" alt="화살표" style="width:8px; height:13px; margin-left:15px;">
                <span style="font-weight: 350; font-size:14px; color:#071F4B; margin-left:15px;">자료실</span>
        </div>
    </div>
        ...
        <div style="display: flex; gap: 60px;">
                ...
                <table class="banner sidebar" style="border-collapse:collapse; width:100%; border-top:2px solid black;">
                    ...
                    <tr>
                        <td style="background-color: #5198f9; border-bottom: 1px solid #e9e9e9;">
                            <a href="#" style="color: white; font-weight:300;" class="active">자료실</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div style="padding-top:9px; width: 930px;">
                ...
                <table style="border-collapse: collapse; border:1px solid; width:100%; text-align: center; border:none;">
                    ...
                    <c:forEach var="commu" items="${dtoList}" varStatus="status">
			            <tr style="height:60px;">
			                ...
			                <td style="width: 500px; border-bottom: 1px solid #b8b8b8; text-align: left;"><a href="#" style="color:black; display:flex; align-items: center;">&nbsp;<img src="/greenUniv/images/ico-file01.png" alt="" style="margin-right:10px;margin-top:3px;">${commu.title}</a></td>
                ...
                <form action="" method="get" style="text-align: center; display:flex; justify-content: center;">
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_refer_search.do?pg=${pagenationDTO.pageGroupStart}&searchType=${searchType}&keyword=${keyword}'" class="first-page">
	                    <!-- 이전 페이지: 1페이지일 때 비활성화 -->
						<c:choose>
						  ...
						  <c:otherwise>
						    <input type="button"
						           onclick="location.href='${pageContext.request.contextPath}/community/comm_refer_search.do?pg=${pagenationDTO.currentPage-1}&searchType=${searchType}&keyword=${keyword}'"
						           class="prev-page">
						  </c:otherwise>
						</c:choose>
						
						<c:forEach var="num" begin="${pagenationDTO.pageGroupStart}" end="${pagenationDTO.pageGroupEnd}">
	                    	<input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_refer_search.do?pg=${num}&searchType=${searchType}&keyword=${keyword}'" value="${num}" class="${pagenationDTO.currentPage == num ? 'current' : 'off'}" style="">
	                    </c:forEach>
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_refer_search.do?pg=${pagenationDTO.pageGroupEnd}&searchType=${searchType}&keyword=${keyword}'" class="last-page">
	                </form>
                </div>
            </div>
        </div>
