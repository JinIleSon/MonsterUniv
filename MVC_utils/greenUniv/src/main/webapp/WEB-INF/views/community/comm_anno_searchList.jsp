            ...
            <div style="padding-top:9px; width: 930px;">
               ...
               <hr style="border:none; border-top: 2px solid;">
                <div style="display: flex; width:100%; margin-top:30px; margin-bottom:20px; justify-content: flex-end;">
                    <form action="/greenUniv/community/comm_anno_search.do" method="get" style="display: flex;">
                ...
                <div style=" height: 100px; margin-top:30px;">
	                <form action="" method="get" style="text-align: center; display:flex; justify-content: center;">
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_anno_search.do?pg=${pagenationDTO.pageGroupStart}&searchType=${searchType}&keyword=${keyword}'" class="first-page">
	                    <!-- 이전 페이지: 1페이지일 때 비활성화 -->
						<c:choose>
						  ...
						  <c:otherwise>
						    <input type="button"
						           onclick="location.href='${pageContext.request.contextPath}/community/comm_anno_search.do?pg=${pagenationDTO.currentPage-1}&searchType=${searchType}&keyword=${keyword}'"
						           class="prev-page">
						  </c:otherwise>
						</c:choose>
						
						<c:forEach var="num" begin="${pagenationDTO.pageGroupStart}" end="${pagenationDTO.pageGroupEnd}">
	                    	<input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_anno_search.do?pg=${num}&searchType=${searchType}&keyword=${keyword}'" value="${num}" class="${pagenationDTO.currentPage == num ? 'current' : 'off'}" style="">
	                    </c:forEach>
	                    ...
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/community/comm_anno_search.do?pg=${pagenationDTO.pageGroupEnd}&searchType=${searchType}&keyword=${keyword}'" class="last-page">
	                </form>
                </div>
            </div>
        </div>
