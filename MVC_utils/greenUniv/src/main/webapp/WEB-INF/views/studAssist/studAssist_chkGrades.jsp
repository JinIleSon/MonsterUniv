						...
						<li style="position: relative;"><a href="#">커뮤니티</a>
							<div
								...
								<img src="/greenUniv/images/bg-path-arrow.png" alt="화살표"
									style="width: 8px; height: 13px; margin-left: 15px;"> <span
									style="font-weight: 350; font-size: 14px; color: #071F4B; margin-left: 15px;">성적조회</span>
							</div></li>
					</ul>
				</div>
			</div>
		...
		<div style="display: flex; gap: 60px;">
				...
				<table class="banner"
					...
					<tr>
						<td
							...
							<a href="#" style="color: white; font-weight: 300;">성적조회</a>
						</td>
					</tr>
					<tr>
						<td style="border-bottom: 1px solid #e9e9e9;"><a href="#"
			...
			<div style="padding-top: 9px; width: 930px;">
				...
				<div
					...
					<span
						style="margin-top: 15px; margin-left: 370px; font-weight: 700; font-size: 14pt;">이수과목수
						5과목, 총 신청학점 <font color="#ae2725">15</font>학점
					</span>
				</div>
				<table
					...
					<tr style="height: 70px; border-bottom: 1px solid #b8b8b8;">
						...
						<td>A+</td>
						<td>3</td>
						<td><input type="button" value="상세확인"
							style="background-color: #092E71; color: white; font-weight: 300; height: 30px; width: 64px; border: none;">
						</td>
					</tr>
					<tr style="height: 70px; border-bottom: 1px solid #b8b8b8;">
						<td>830003</td>
				...
				<span style="color: #666666; font-size: 16px;">※ 점수 이의신청은
					학생지원실에 문의하시기 바랍니다.</span>
			</div>
		</div>
	</div>
	<!--3. 푸터영역-->
