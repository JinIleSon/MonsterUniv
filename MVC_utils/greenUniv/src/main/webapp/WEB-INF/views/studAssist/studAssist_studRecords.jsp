                        ...
                        <li style="position: relative;">
                            ...
                            <div style="width:197.25px; height:42px;
                              ...
                              ">
                                ...
                                <span style="font-weight: 350; font-size:14px; color:#333333; margin-left:21px;">학생지원</span>
                                <img src="../images/bg-path-arrow.png" alt="화살표" style="width:8px; height:13px; margin-left:21px;">
                                <span style="font-weight: 350; font-size:14px; color:#071F4B; margin-left:21px;">학적</span>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div style="display: flex; gap: 60px;">
            ...
            <div style="padding-top:9px; width: 930px;">
                ...
                <div style="display: flex; width:100%; margin-top:30px; margin-bottom:7px; align-items: center;">
                    <img src="../images/bullet-h4.png" alt="" style="margin-right:6px; width:4px; height:18px; margin-top:5px;"><span style="color:#145074; font-size:18px; font-weight: 500;">기본정보</span>
                </div>
                <table style="border-collapse: collapse; border:none; width: 100%; height:202px; text-align: center; font-size:16px;">
                    <tr style="height:50px;">
                        <td rowspan="4" style="border-top: 2px #071F4B solid; border-right: 1px #DEDEDE solid; border-left:none; border-bottom: 1px #DEDEDE solid;"><img src="../images/icon-avatar.png" alt=""></td>
                ...
                <div style="display: flex; width:100%; margin-top:50px; margin-bottom:7px; align-items: center;">
                    <img src="../images/bullet-h4.png" alt="" style="margin-right:6px; width:4px; height:18px; margin-top:2px;"><span style="color:#145074; font-size:18px; font-weight: 500;">취득학점현황</span>
                </div>
                ...
                <div style="display: flex; width:100%; margin-top:50px; margin-bottom:7px; align-items: center;">
                    <img src="../images/bullet-h4.png" alt="" style="margin-right:6px; width:4px; height:18px;"><span style="color:#145074; font-size:18px; font-weight: 500;">년도/학기별 취득학점현황</span>
                </div>
                <table style="border-collapse: collapse; border:none; width: 100%; text-align: center; font-size:16px;">
                    <tr style="border-top: 2px #071F4B solid; border-right: 1px #DEDEDE solid; border-left:none; border-bottom: 1px #DEDEDE solid; height:50px; background-color: #F4F8FC; border-right:none;">
