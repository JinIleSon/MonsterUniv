                        ...
                        <li style="position: relative;">
                            ...
                            <div style="width:197.25px; height:42px;
                              ...
                              ">
                                ...
                                <img src="../images/bg-path-arrow.png" alt="화살표" style="width:8px; height:13px; margin-left:24px;">
                                <span style="font-weight: 350; font-size:14px; color:#333333; margin-left:24px;">회원</span>
                                <img src="../images/bg-path-arrow.png" alt="화살표" style="width:8px; height:13px; margin-left:24px;">
                                <span style="font-weight: 350; font-size:14px; color:#071F4B; margin-left:24px;">로그인</span>
                            </div>
                        </li>
                    </ul>
                </div>
