...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <ul class="pagenation">
                <li><a href="${pageContext.request.contextPath}/AMS/AMS_lectureList_search.do?pg=${pagenationDTO.pageGroupStart}&searchType=${searchType}&keyword=${keyword}"><span class="first"></span></a></li>
                <c:choose>
                	<c:when test="${pagenationDTO.currentPage == 1}">
                		<li><a href="#" style="pointer-events: none;"><span class="prev"></span></a></li>
                	</c:when>
                	<c:otherwise>
                		<li><a href="${pageContext.request.contextPath}/AMS/AMS_lectureList_search.do?pg=${pagenationDTO.currentPage-1}&searchType=${searchType}&keyword=${keyword}"><span class="prev"></span></a></li>
                	</c:otherwise>
                </c:choose>
                
                <c:forEach var="num" begin="${pagenationDTO.pageGroupStart}" end="${pagenationDTO.pageGroupEnd}">
                	<li><a href="${pageContext.request.contextPath}/AMS/AMS_lectureList_search.do?pg=${num}&searchType=${searchType}&keyword=${keyword}" class="${pagenationDTO.currentPage == num ? 'page1' : 'page2'}">${num}</a></li>
                </c:forEach>
                ...
                <c:choose>
                	...
                	<c:otherwise>
                		<li><a href="${pageContext.request.contextPath}/AMS/AMS_lectureList.do?pg=${pagenationDTO.currentPage+1}&searchType=${searchType}&keyword=${keyword}"><span class="next"></span></a></li>
                	</c:otherwise>
                </c:choose>
                <li><a href="${pageContext.request.contextPath}/AMS/AMS_lectureList.do?pg=${pagenationDTO.pageGroupEnd}&searchType=${searchType}&keyword=${keyword}"><span class="last"></span></a></li>      
            </ul>
        </main>
    </div>
