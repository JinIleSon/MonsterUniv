        ...
        <main class="main-content">
            ...
            <div class="main-lecture1">
                ...
                <div class="list1">
                    ...
                    <div>주민등록번호</div>
                    <div><input type="text" placeholder="- 포함 14자리 입력"></div>
                </div>
                <div class="list2">
                    <div>이름</div>
                    <div>
                        <input type="text" placeholder="교수 이름 입력">
                    </div>
                    <div>영문명</div>
                    <div>
                        <input type="text" placeholder="여권 등과 동일한 영문 이름">
                    </div>
                </div>
                <div class="list3">
                    <div>성별</div>
            ...
            <div class="main-lecture2">
                <div class="list6">
                    <div>졸업대학</div>
                    <div>
                        <input type="text" placeholder="대학교 이름 입력">
                    </div>
                    <div>학문 분야(전공)</div>
                    <div>
