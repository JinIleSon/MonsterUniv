...
<body>
    <header>
        <div>
            <nav>
                <div>
                    <div style="width: 189px; height: 28px; align-items: center; display: flex; position: relative; left: 76%;">
                        <ul>
                            <li style="margin-right: 25px;"><a href="#">HOME</a><div></div></li>
                            <li style="margin-right: 25px;"><a href="#">사이트맵</a><div></div></li>
                            <li><a href="#">로그아웃</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <nav class="sidebar">
                        <div class="menu menu1">
                            <h3><img src='../images/ico-admin-setting.png'><a href="#">환경설정</a></h3>
                            <ul>
                        ...
                        <div class="menu menu2">
                            <h3><img src='../images/ico-admin-academic.png'><a href="#">학사운영</a></h3>
                            <ul>
                        ...
                        <div class="menu menu3">
                            <h3><img src='../images/ico-admin-persons.png'><a href="#">학생 목록 및 등록</a></h3>
                            <ul>
                        ...
                        <div class="menu menu4">
                            <h3><img src='../images/ico-admin-college.png'><a href="#">인사관리</a></h3>
                            <ul>
                        ...
                        <div class="menu menu5">
                            <h3><img src='../images/ico-admin-board.png'><a href="#">게시판관리</a></h3>
                            <ul>
            ...
            <section>
                <div style="width: 1130px; height: 1300px;">
                    <div class="main-title">
                        <h3>운영현황 메인</h3>
                        <p style="font-size: 14px;">HOME &nbsp; > &nbsp; <span>운영현황 메인</span></p>
                    </div>
                    <div class="sub-title">
                        <h4>대학 운영 현황</h4>
                    </div>
                    ...
                    <div class="sub-title">
                        <h4>대학 운영 현황</h4><a href="#"><img src="../images/bg-viewmore01.png" alt=""></a>
                    </div>
                    <div>
                    ...
                    <div style="display: flex; height: 350px;">
                        ...
                        <div style="width: 534.09px;">
                            <div class="sub-title" style="width: 100%; margin-left: 0;">
                                <h4>학과별 학생 현황</h4><a href="#"><img src="../images/bg-viewmore01.png" alt=""></a>
                            </div>
                            <div>
                                <table style="height: 300px;">
                                    <colgroup>
                    ...
                    <div style=" display: flex; height: 362px;">
                        <div style="width: 534.09px; margin-right: auto;">
                            <div class="sub-title" style="width: 100%; margin-left: 0;">
                                <h4>학사안내 공지사항</h4><a href="#"><img src="../images/bg-viewmore01.png" alt=""></a>
                            </div>
                            <div>
                                <table style="height: 307px;">
                                    <tr class="thead">
                        ...
                        <div style="width: 534.09px;">
                            <div class="sub-title" style="width: 100%; margin-left: 0;">
                                <h4>입학상담</h4><a href="#"><img src="../images/bg-viewmore01.png" alt=""></a>
                            </div>
                            <div>
                                <table style="height: 307px;">
                                    <colgroup>
                                        <col style="width: 73.41px;">
                                        <col style="width: 233.63px;">
                                        <col style="width: 113.53px;">
                                        <col style="width: 113.53px;">
                                    </colgroup>
                                    <tr class="thead">
                                        <th>번호</th>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>[정시] 정시모집 관련해 문의드립니다.</td>
                                        <td>24.06.24</td>
                                        <td><b style="color: #CD3631; font-weight: 500;">답변대기</b></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>2025학년도 신입학 추가모집 모집…</td>
                                        <td>24.06.24</td>
                                        <td><b style="color: #207918; font-weight: 500;">답변완료</b></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>2025학년도 신입학 추가모집 모집…</td>
