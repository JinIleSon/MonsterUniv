...
<body>
	...
	<main style="background-color: white !important;">
		<div
			...
			<div
				style="width: 250px; height: 42px; position: absolute; transform: translateX(182%); display: flex; align-items: center;">
				...
				<img src="/greenUniv/images/bg-path-arrow.png" alt="화살표"
					style="width: 8px; height: 13px; margin-left: 15px;"> <span
					style="font-weight: 350; font-size: 14px; color: #071F4B; margin-left: 15px;">자연과학대학</span>
			</div>
		</div>
		<!-- 사이드바 시작-->
			...
			<div style="display: flex; gap: 60px; min-width: 205px;">
					...
					<table class="banner sidebar"
						...
						<tr>
							<td
								...
								<a href="#" style="color: white;" class="active">자연과학대학</a>
							</td>
						</tr>
						<tr>
							<td style="border-bottom: 1px solid #e9e9e9;"><a
				...
				<div style="padding-top: 9px; width: 898px !important;">
					...
					<div
						...
						<img src="/greenUniv/images/college-introduce-2.jpg" alt=""
							style="width: 320px; height: 240px;">
						<div style="">
							<div
								style="font-weight: 350; font-size: 16px; color: #5B6774; margin-bottom: 8px;">Natural
								Sciences</div>
							<div
								style="font-weight: 350; font-size: 26px; color: #3B88D4; margin-bottom: 11px;">자연과학의
								기초 이론 교수와 연구, 융합 및 응용과학의 토대 제공</div>
							<div style="font-weight: 350; font-size: 16px; color: #666666;">자연과학대학은
								미래 첨단과학기술사회의 학계, 연구소, 산업계 등을 주도적으로 이끌어 나 갈 기초과학 인재 양성을 교육목표로 한다.
								자연과학의 근간이 되는 물리, 화학, 응용수학, 미 생물학, 과학컴퓨팅 및 간호학의 기초 이론을 교수·연구하고 융합
								및 응용과학의 토대를 제공할 것이다.</div>
						</div>
					</div>
					<div
					...
					<div style="">
						<table
							style="border-collapse: collapse; width: 898px !important; text-align: center; border: none; width: 930px;">
							<tr
