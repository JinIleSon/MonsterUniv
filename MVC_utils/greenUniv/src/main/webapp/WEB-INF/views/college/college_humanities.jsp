		...
		<div
			...
			<div
				...
				<img src="/greenUniv/images/bg-path-arrow.png" alt="화살표"
					style="width: 8px; height: 13px; margin-left: 15px;"> <span
					style="font-weight: 350; font-size: 14px; color: #071F4B; margin-left: 15px;">인문사회대학</span>
			</div>
		</div>
		<!-- 사이드바 시작-->
			...
			<div style="display: flex; gap: 60px; min-width: 205px;">
				<div style="width: 203px; flex-shrink: 0;">
					...
					<table class="banner sidebar"
						...
						<tr>
							<td
								style="background-color: #5198f9; border-bottom: 1px solid #e9e9e9;"><a
								href="#" style="color: white;" class="active">인문사회대학</a></td>
						</tr>
						<tr>
				...
				<div style="padding-top: 9px; width: 898px !important;">
					...
					<div
						...
						<img src="/greenUniv/images/college-introduce-4.jpg" alt=""
							style="width: 320px; height: 240px;">
						<div style="">
							<div
								style="font-weight: 350; font-size: 16px; color: #5B6774; margin-bottom: 8px;">Humanities
								And Social Sciences</div>
							<div
								style="font-weight: 350; font-size: 26px; color: #3B88D4; margin-bottom: 11px;">인문,
								사회분야의 다양하고 심화된 이론을 연구</div>
							<div style="font-weight: 350; font-size: 16px; color: #666666;">
								인문사회과학대학은 민족의 문화적 유산과 전통을 창조적으로 계승.발전시킬 열린 민족인, 세계화된 지식, 정보사회를
								주도할 수 있는 국제적인 식견을 갖춘 전문인, 법, 정치 경제, 언 론등 우리사회의 중심을 이루는 영역에서 정의로운
								사명감을 가지고 일 할 양심적인 봉사자, 그리고 창의적인 디자인 활동을 할 개성적인 인재를 양성하기 위해서 인문,
								사회, 디자인 영 역의 다양하고 심화된 이론과 실제를 교수.연구하는데 교육목표를 둔다.</div>
						</div>
					</div>
					<div
