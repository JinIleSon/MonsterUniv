...
<body>
	...
	<div class="container">
		...
		<main class="main-content">
			...
			<form class="search-form" action="/greenUniv/AMS/AMS_educationOperation/search.do" method="get">
			...
			<ul class="pagenation">
				<li><a href="/greenUniv/AMS/AMS_educationOperation/search.do?pg=1&searchType=${searchType}&keyword=${keyword}"><span class="first"></span></a></li>
				<li><a href="/greenUniv/AMS/AMS_educationOperation/search.do?pg=${ pagenationDTO.currentPage > 1 ? pagenationDTO.currentPage - 1 : 1 }&searchType=${searchType}&keyword=${keyword}"><span class="prev"></span></a></li>
            <c:forEach var="num" begin="${ pagenationDTO.pageGroupStart }" end="${ pagenationDTO.pageGroupEnd }">
				<li><a href="/greenUniv/AMS/AMS_educationOperation/search.do?pg=${ num }&searchType=${searchType}&keyword=${keyword}" class="${ pagenationDTO.currentPage == num ? 'current' : 'off' }">${ num }</a></li>
			</c:forEach>
				<li><a href="/greenUniv/AMS/AMS_educationOperation/search.do?pg=${ pagenationDTO.currentPage < pagenationDTO.lastPageNum ? pagenationDTO.currentPage + 1 : pagenationDTO.lastPageNum }&searchType=${searchType}&keyword=${keyword}"><span class="next"></span></a></li>
				<li><a href="/greenUniv/AMS/AMS_educationOperation/search.do?pg=${ pagenationDTO.lastPageNum }&searchType=${searchType}&keyword=${keyword}"><span class="last"></span></a></li>
			</ul>
		</main>
	</div>
